...
import { createPurchaseSchema } from '../validators/transaction.js';
...
router.put('/purchases/:id/payment', requirePermission('purchases.update'), asyncHandler(purchase.updatePaymentStatus));
