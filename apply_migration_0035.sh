...
#
# CATATAN: jalankan SETELAH 0034_price_movements.sql di-apply.

set -e

echo "=================================================="
echo "  Apply Migration 0035: Revisi pergerakan harga"
echo "=================================================="
...
MIGRATION_FILE="supabase/migrations/0035_status_barang_revisi_harga.sql"
